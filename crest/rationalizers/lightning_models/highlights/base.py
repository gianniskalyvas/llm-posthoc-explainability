...
class BaseRationalizer(pl.LightningModule):
    ...
    def __init__(
        ...
        self.stage = None
        # Store outputs for epoch end hooks (PyTorch Lightning 2.0 compatibility)
    ...
    def training_step(self, batch: dict, batch_idx: int):
        ...
        output = {"loss": loss, "ps": loss_stats[prefix + "_ps"]}
    ...
    def _shared_eval_step(self, batch: dict, batch_idx: int, prefix: str):
        ...
        self.log_dict(loss_stats, on_step=False, on_epoch=True)
    ...
    def on_validation_epoch_end(self):
        self._shared_eval_epoch_end(self.validation_step_outputs, prefix="val")
        self.validation_step_outputs.clear()

    def on_test_epoch_end(self):
        self._shared_eval_epoch_end(self.test_step_outputs, prefix="test")
